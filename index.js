const contentLetterSrart_actived = "Háp pi bớt đây bạn của tôi nha <333." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc bạn ngày càng vui vẻ, càng xinh gái nha, tuổi mới muốn tiền được tiền, chúc bạn sống mãi trong ánh sáng của 10 phương chư phật nha :))))." //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/du.jpg";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/du2.jgp"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
...
document.querySelector("#mess").addEventListener("change", function () { //Hiệu ứng gõ chữ cho phần nội dung của bức thư
    if (this.checked == true) {
        ...
        splitMainContentLetter.forEach((val, index) => {
            setTimeout(() => {
                ...
                if (index == mainContentLetter.length - 1) {
                    document.querySelector(".img").setAttribute("style", "opacity: 1; transition: .5s")
                }
            }, 50 * index)
        })
        ...
        document.querySelector(".img").setAttribute("style", "opacity: 0; transition: .5s")
